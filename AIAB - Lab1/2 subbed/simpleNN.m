...
x = linspace(-0.2,1.2);
y = (0.6-0.5*x)/0.5;
plotGraph(AND_In,AND_Out,1,'AND Gate',x,y);
print -dpng AND.png
...
x = linspace(0,1.2);
y = (0.4-0.5*x)/0.5;
plotGraph(OR_In,OR_Out,2,'OR Gate',x,y);
print -dpng OR.png
...
x = linspace(-0.2,1.2);
y = (0.6-0.5*x)/0.5;
plotGraph(NAND_In,NAND_Out,3,'NAND Gate',x,y);
print -dpng NAND.png
...
xorWeights1 = [20 20 -10; -20 -20 30]; % Third number is the bias (-10 and 30)
